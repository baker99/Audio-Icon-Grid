...
This plugin was originally developed for my own workflow, with much of the implementation produced through AI‑assisted coding. The structure and approach reflect that “AI‑generated development vibe,” but the functionality is stable, secure, and fit for purpose. I’m making it publicly available in case others find it useful or want to extend it further. Contributions, improvements, and refactors are welcome — feel free to fork the project and evolve it in whatever direction suits your needs.
